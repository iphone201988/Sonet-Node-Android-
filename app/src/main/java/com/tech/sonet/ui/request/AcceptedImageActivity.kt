...
import com.tech.sonet.databinding.AcceptedimageActivityBinding
...
@AndroidEntryPoint
class AcceptedImageActivity : BaseActivity<AcceptedimageActivityBinding>() {
    private val viewModel: AcceptedImageVM by viewModels()
    ...
    override fun getLayoutResource(): Int {
        return R.layout.acceptedimage_activity
    }
